            ...
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  validator: (v) => (v == null || v.trim().isEmpty) ? 'ID é obrigatório' : null,
                ),
        ...
        actions: [
          ...
          OutlinedButton(
            ...
            onPressed: () async {
              ...
              final updatedId = idCtrl.text.trim();
              if (updatedId.isEmpty) {
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('ID não pode ficar vazio.')));
                return;
              }
